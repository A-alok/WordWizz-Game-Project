...
public class FruitGrid {
    ...
    public FruitGrid() {
        ...
        fruits = new String[]{
                "Apple", "Banana", "Mango", "Pear", "Grape", "Guava", "Peach", "Plum", "Papaya", "Lychee", "Orange", "Lemon", "Fig", "Dates", "Kiwi", "Berry", "Cherry", "Melon", "Coconut", "Avocado", "Sapota", "Tamarind"
    ...
    private void initializeGrid() {
        for (int i = 0; i < ROWS; i++) {
            for (int j = 0; j < COLS; j++) {
                ...
                grid[i][j].setFocusable(false); // Disable focus on clicking
            }
        }
    }
    ...
    private void createAndShowGUI() {
        ...
        JPanel backgroundPanel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                ImageIcon backgroundImage = new ImageIcon("C:\\Users\\vinay\\Downloads\\miniiiiiiiiii\\miniiiiiiiiii\\icon\\3.png"); // Set your fruit background image path
